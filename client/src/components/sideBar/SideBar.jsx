    ...
    <div className="sidebar fixed inset-0 h-screen flex transition ease-in-out bg-red-200 w-60">
      ...
      <div className="flex h-[65px] sticky items-center justify-start">
        ...
        <div className="flex flex-col text-[13px] tracking-wider pr-[30px] mb-[20px]">
          <button
            className={`flex items-center mt-2 py-2 pl-7 text-primary-content font-medium hover:bg-orange-100 rounded-r-full ${window.location.pathname === '/' ? 'bg-orange-300 hover:bg-orange-300' : 'bg-orange-000'}`}
          ...
          <button
            className={`flex items-center mt-2 py-2 pl-7 text-primary-content font-medium hover:bg-orange-100 rounded-r-full ${window.location.pathname === '/markettrend' ? 'bg-orange-300 hover:bg-orange-300' : 'bg-orange-000'}`}
            onClick={() => handleNavigation('/markettrend')}
          >
            <img src={MarketTrendIcon} className="w-5" alt="Market Trends" />
            <span className="pl-[14px] pb-[1px]">Market Trends</span>
          </button>
          <button
            className={`flex items-center mt-2 py-2 pl-7 text-primary-content font-medium hover:bg-orange-100 rounded-r-full ${window.location.pathname === '/community' ? 'bg-orange-300 hover:bg-orange-300' : 'bg-orange-000'}`}
          ...
          <button
            className={`flex items-center mt-2 py-2 pl-7 text-primary-content font-medium hover:bg-orange-100 rounded-r-full ${window.location.pathname === '/userguide' ? 'bg-orange-300 hover:bg-orange-300' : 'bg-orange-000'}`}
